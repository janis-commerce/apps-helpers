...
function formatDeviceDataForUserAgent(deviceData) {
	...
	return {
		'user-agent': `${deviceData['janis-app-package-name']}/${deviceData['janis-app-version']} (${deviceData['janis-app-name']}; ${deviceData['janis-app-build']}) ${deviceData['janis-app-device-os-name']}/${deviceData['janis-app-device-os-version']} (${deviceData['janis-app-device-id']}; ${deviceData['janis-app-device-name']})`
	};
}
