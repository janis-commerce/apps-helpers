...
<dt><a href="#isEmptyArray">isEmptyArray(arr)</a> ⇒ <code>bool</code></dt>
<dd><p>return true or false if arg is a valid array and has length</p></dd>
<dt><a href="#isEmptyObject">isEmptyObject(obj)</a> ⇒ <code>bool</code></dt>
<dd><p>return true or false if arg is a valid object and has or not keys</p></dd>
...
## isEmptyArray(arr) ⇒ <code>bool</code>

<p>return true or false if arg is a valid array and has length</p>
...
## isEmptyObject(obj) ⇒ <code>bool</code>

<p>return true or false if arg is a valid object and has or not keys</p>
